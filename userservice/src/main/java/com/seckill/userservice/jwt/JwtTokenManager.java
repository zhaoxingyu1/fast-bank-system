package com.seckill.userservice.jwt;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.seckill.common.utils.EmptyUtil;
import com.seckill.common.utils.EncodesUtil;
...
public class JwtTokenManager {
    ...
    public String issuedToken(String iss, long ttlMillis, String sessionId, Map<String,Object> claims){
        ...
        //获取加密签名
        String base64EncodedSecretKey = EncodesUtil.encodeBase64(JwtProperties.base64EncodedSecretKey.getBytes());
        //构建令牌
    ...
    public boolean isVerifyToken(String jwtToken){
        ...
        //JwtProperties.base64EncodedSecretKey 获取签名

        Algorithm algorithm = Algorithm.HMAC256(JwtProperties.base64EncodedSecretKey.getBytes());
